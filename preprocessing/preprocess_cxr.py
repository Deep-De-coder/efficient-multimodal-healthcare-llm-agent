...
def main():
    parser = argparse.ArgumentParser(description='Preprocess MIMIC-CXR reports into chunks.')
    parser.add_argument('--input', required=True, help='Input cleaned CXR JSONL')
